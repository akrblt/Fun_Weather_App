...
import sunJson from '../../assets/animations/sun_sun.json'
import sunKids from '../../assets/animations/sun_kids_play.json'
import sunButterfly from '../../assets/animations/sun_butterfly.json'
</script>

<template>
  <div class="lottie-canvas">
    <div class="layer sun">
